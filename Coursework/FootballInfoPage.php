    ...
    <div class="column">
      ...
      <form method = "post" action="FootballInfoPage.php">
        ...
        if (isset($_POST['like'])){
          ...
          $sql = "UPDATE event_likes SET likes = likes+1 WHERE event = '1'";
        ...
        ?>
        <input type="submit" name="RemoveLike" value="Remove Like"/>
        <?php
        if (isset($_POST['RemoveLike'])){
          ...
          $sql = "DELETE FROM event_likes WHERE email = '$_POST'";
        ...
        ?>
        <input type= "Submit" name = "Submit"  value = "Register" id = "Register"/><br><br><br>
        <?php
